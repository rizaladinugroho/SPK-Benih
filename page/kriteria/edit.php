                ...
                <div class="column">
                    <div class="card">
                        <div class="card-header">
                            <p class="card-header-title">Form Ubah Kriteria</p>
                            ...
                            <form action="" method="post">
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        ...
                                        <input class="input" type="text" placeholder="kode" name="kode_kriteria" value="<?= $row["kode_kriteria"] ?>">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <input class="input" type="text" placeholder="kriteria" name="nm_kriteria" value="<?= $row["nm_kriteria"]; ?>">
                                        <span class="icon is-small is-left">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control has-icons-left">
                                        <div class="select">
                                            <select name="bobot">
                                                <option selected disabled><?= $row["bobot"]; ?></option>
