            ...
            <div class="columns">
                <div class="column">
                        <div class="card-header">
                            <p class="card-header-title">Tabel Alternatif</p>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="buttons">
                                                        <a class="button is-link" href="index.php?halaman=editdataalternatif&id=<?= $row['id_alternatif']; ?>">
    ...
    function DeleteData() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "index.php?halaman=hapusdataalternatif&id=<?= $row['id_alternatif']; ?>";
            }
        })
    }
</script>