...
function Add($table, $data)
{
    ...
    $alternatif = htmlspecialchars($data["nm_kriteria"]);
    $bobot = htmlspecialchars($data["bobot"]);
    $status = htmlspecialchars($data["status"]);
    $query = "INSERT INTO $table VALUES (null, '$kode', '$alternatif','$bobot','$status')";
...
function Edit($table, $data)
{
    ...
    $bobot = htmlspecialchars($data["bobot"]);
    $status = htmlspecialchars($data["status"]);
    $query = "UPDATE $table SET kode_kriteria = '$kode', nm_kriteria = '$alternatif', bobot = '$bobot', status = '$status' WHERE id_kriteria = $idkriteria";
